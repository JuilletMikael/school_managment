...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { master_id: @classroom.master_id, name: @classroom.name, room_id: @classroom.room_id, uid: @classroom.uid } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { master_id: @classroom.master_id, name: @classroom.name, room_id: @classroom.room_id, uid: @classroom.uid } }
